...
object1 = model_loader.load_object(filename="_resources/monkey.obj", tx_name='_resources/crate.jpg', pos=[-1.5, 0, 5],
                                   rot=[0, 0, 0], scale=[1, 1, 1])
object2 = model_loader.load_object(filename="_resources/monkey.obj", tx_name='_resources/crate.jpg', pos=[1.5, 0, 5],
                                   rot=[0, 0, 0], scale=[1, 1, 1])
object3 = model_loader.load_object(filename="_resources/monkey.obj", tx_name='_resources/crate.jpg', pos=[0, 0.25, 5],
                                   rot=[0, 0, 0], scale=[1, 1, 1])
